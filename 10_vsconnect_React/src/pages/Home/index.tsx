...
function mostrarMenu() {
    ...
    return (
        // Tag vazia antes de colocar o codigo html fragmento
        <>
            <div id="sombra"></div>
            <header>
                <div className="container header_conteudo">
                    {/* <a 
                    className="menu_barras" href="#"><img onClick={mostrarMenu} src="../Imagens/Menu de barras.svg" alt=""/></a>  */}
